        ...
        <div class="row justify-content-center">
            <div class="col-xl-6">
                <div class="section_tittle text-center">
                    <h2>Restaurants</h2>
                    <p>호텔의 강점인 탁트인 도심의 전경을 바라보며 세계 최고 수준의 셰프들이 직접 선보이는 다양한 요리를 즐기실 수 있습니다.</p>
                </div>
            </div>
        </div>
        <section class="accomodation_area section_gap">
            <div class="container">
                <div style="text-align:center">
                    ...
                    <font style="font-family: 'Noto Sans KR', sans-serif; font-size:35px; color:red; font-weight: 500; "><%=foodName%></font>
                    <br><br><hr>
                    </form>
                </div>
                <!--===== 레스토랑 사진 슬라이드 =====-->
