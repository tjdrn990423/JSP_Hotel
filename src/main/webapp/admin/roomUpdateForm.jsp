        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="alert" style="padding-left:50px; padding-right:50px">
                    <br>
                    <form id="roomUpdate" action="roomUpdate.do" method="post" enctype="multipart/form-data">
                        <input type="hidden" class="form-control" name="no" id="no" type="text" value="${roomList.no}" placeholder="name" data-sb-validations="required"  />
                        <div class="form-floating">
                            <label for="name">Name</label>
                            <input class="form-control" name="name" id="name" type="text" value="${roomList.name}" placeholder="name" data-sb-validations="required"  />
                        ...
                        <div class="form-floating">
                            ...
                            <input class="form-control" name="ex" id="ex" type="text" value="${roomList.ex}" placeholder="ex gogo" data-sb-validations="required"  />
                            <div class="invalid-feedback" data-sb-feedback="phone:required">ex</div>
                        </div>
                        <div class="form-floating">
                            <label for="price">Price</label>
                            <input class="form-control" name="price" id="price" type="text" value="${roomList.price}" placeholder="price gogo" data-sb-validations="required" />
                            <div class="invalid-feedback" data-sb-feedback="phone:required">price</div>
                        </div>
                        <div class="form-floating">
                            <label for="pic1">Pic1</label>
                            <input class="form-control" name="pic1" id="pic1" type="file" value="${roomList.pic1}" placeholder="pic1 gogo" data-sb-validations="required" />
                            <div class="invalid-feedback" data-sb-feedback="phone:required">pic1</div>
                        </div>
                        <div class="form-floating">
                            <label for="pic2">Pic2</label>
                            <input class="form-control" name="pic2" id="pic2" type="file" value="${roomList.pic2}" placeholder="pic2 gogo" data-sb-validations="required" />
                            <div class="invalid-feedback" data-sb-feedback="phone:required">pic2</div>
                        </div>
                        <div class="form-floating">
                            <label for="pic3">Pic3</label>
                            <input class="form-control" name="pic3" id="pic3" type="file" value="${roomList.pic3}" placeholder="pic3 gogo" data-sb-validations="required" />
