            ...
            <div class="table-responsive">
                <div class="alert" style="padding-left:50px; padding-right:50px">
                    ...
                    <form id="adRestaurantsDetail" action="adRestaurantsDetail.do" method="post">
                        ...
                        <div class="form-floating">
                            <img src="../${restaurantsList.pic1}"> <!--서버에서 이미지 받아오기-->
                            <img src="../${restaurantsList.pic2}"> <!--서버에서 이미지 받아오기-->
                            <img src="../${restaurantsList.pic3}"> <!--서버에서 이미지 받아오기-->
                        </div>
                        <br />
                        ...
                        <button class="btn btn-primary text-uppercase" type="button" onclick="location.href='restaurantsUpdateForm.do?no=${restaurantsList.no}';">수정</button>
                        <button class="btn btn-primary text-uppercase" type="button" onclick="location.href='restaurantsDelete.do?no=${restaurantsList.no}';">삭제</button>
                    </form>
