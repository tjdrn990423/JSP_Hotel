            ...
            <div class="table-responsive">
                <div class="alert" style="padding-left:50px; padding-right:50px">
                    ...
                    <form id="memberDetail" action="memberDetail.do" method="post">
                        ...
                        <button class="btn btn-primary text-uppercase" type="button" onclick="location.href='memberUpdateForm.do?no=${memberList.no}';">수정</button>
                        <button class="btn btn-primary text-uppercase" type="button" onclick="location.href='memberDelete.do?no=${memberList.no}';">삭제</button>
                    </form>
